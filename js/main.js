...
var iconMenu = document.querySelector('.icon-burger');
var body = document.querySelector('body');
var menu = document.querySelector('.menu-top-header');
...
//<SPOLLERS>===========================================================================================
const spollerButtons = document.querySelectorAll('.spoller-header__title');
const spollerBodies = document.querySelectorAll('.spoller-header__body');
